...
public class PlayerInAirState : PlayerState
{
    ...
    public override void LogicUpdate()
    {
        ...
        else if (player.InputHandler.AttackInputs[(int)CombatInputs.secondary] && Stats.currentMana >= playerData.arrowMana && Time.time >= player.lastShootingTime + player.shootCooldown)
        {
