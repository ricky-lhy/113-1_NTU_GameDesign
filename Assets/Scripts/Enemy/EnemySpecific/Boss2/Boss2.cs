...
public class Boss2 : Entity
{
    ...
    public B2_DeadState deathState {get; private set;}
    ...
    public override void Awake()
    {
        ...
        playerDetectedState = new B2_PlayerDetectedState(this, stateMachine, "playerDetected", playerDetectedData, this);
        chargeState = new B2_ChargeState(this, stateMachine, "charge", chargeStateData, this);
        lookForPlayerState = new B2_LookForPlayerState(this, stateMachine, "lookForPlayer", lookForPlayerStateData, this);
        meleeAttackState = new B2_MeleeAttackState(this, stateMachine, "meleeAttack", meleeAttackPosition, meleeAttackStateData, this);
        stunState = new B2_StunState(this, stateMachine, "stun", stunStateData, this);
        deathState = new B2_DeadState(this, stateMachine, "dead", deathStateData, this);
    }
    private void Start() {
